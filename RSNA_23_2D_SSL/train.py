...
if __name__ == "__main__":
    for mode in ["barlowtwins", "byol", "moco", "simsiam", "tico", "vicreg"]:
        weights = torch.load(f"/kaggle/working/RSNA_23_2D_SSL/pretrain_weights/{mode}/fold1/weight.bin", weights_only = True)
        # weights = {"full_cnn": weights["full_cnn"].state_dict(),
        #            "kidney_cnn": weights["kidney_cnn"].state_dict(),
        #            "liver_cnn": weights["liver_cnn"].state_dict(),
        #            "spleen_cnn": weights["spleen_cnn"].state_dict()}
        # torch.save(weights, f"/kaggle/working/RSNA_23_2D_SSL/pretrain_weights/{mode}/fold1/weight.bin")
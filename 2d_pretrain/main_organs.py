...
parser.add_argument("--wd", type = float, default = 1e-4,
                    help = "Weight decay")
parser.add_argument("--warmup_ratio", type = float, default = 2/15, # 2 warmup epochs out of 15 total epochs
...
parser.add_argument("--methods", nargs = '+', type = str, default = ["barlowtwins", "byol", "moco", "tico", "vicreg", "simsiam"],
                    choices = ["barlowtwins", "byol", "moco", "tico", "vicreg", "simsiam"],
...
MODEL_DICT = {"barlowtwins": BarlowTwins, "byol": BYOL, "moco": MoCo, 

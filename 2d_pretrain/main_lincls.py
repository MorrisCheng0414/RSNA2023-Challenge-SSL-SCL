...
parser.add_argument("--methods", nargs = '+', type = str, default = ["barlowtwins", "byol", "moco", "simsiam", "tico", "vicreg"],
                    choices = ["barlowtwins", "byol", "moco", "simsiam", "tico", "vicreg"],
...
DEBUG = False
TRAIN_CNN = args.train_cnn # set True to train cnn weights
    ...
    for k in range(args.kfold):
        for mode in args.methods:
            ...
            for organ in ["full", "kidney", "liver", "spleen"]:
                ...
                extractor.cnn.requires_grad_(TRAIN_CNN) # Freeze CNN weights (if necessary)
